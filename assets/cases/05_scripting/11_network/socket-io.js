!(function(e) {
    if (CC_WECHATGAME) {
        ...
        if (typeof exports === 'object' && 'undefined' !== typeof module) { module.exports = e() }
   ...
   */
     ...
     */
            ...
            JSONPPolling.prototype.doPoll = function () {
                ...
                let isUAgecko = 'undefined' !== typeof navigator && /gecko/i.test(navigator.userAgent);
     ...
     */
            ...
            XHR.prototype.doWrite = function(data, fn) {
                ...
                let req = this.request({ method: 'POST', data: data, isBinary: isBinary });
                let self = this;
                req.on('success', fn);
   ...
   */
        ...
        let hasXHR2 = (function() {
            let XMLHttpRequest = _dereq_('xmlhttprequest');
            let xhr = new XMLHttpRequest({ xdomain: false });
   ...
   */
        ...
        Polling.prototype.uri = function() {
            ...
            if (false !== this.timestampRequests) {
                query[this.timestampParam] = Number(new Date()) + '-' + Transport.timestamps++;
            }
   ...
   */
        ...
        WS.prototype.uri = function() {
            ...
            if (this.timestampRequests) {
                query[this.timestampParam] = Number(new Date());
            }
   ...
   */
     ...
     */
            ...
            let err = { type: 'error', data: 'parser error' };
   ...
   */
        (function(chars) {
            ...
            exports.encode = function(arraybuffer) {
                ...
                let i; let len = bytes.length; let
                    base64 = '';
     ...
     */
            ...
            let blobSupportsArrayBufferView = blobSupported && (function() {
                try {
     ...
     */
            ...
            let blobBuilderSupported = BlobBuilder
   ...
   */
        ...
        let global = (function() { return window })();
   ...
   */
    ...
    /* ! JSON v3.2.6 | http://bestiejs.github.io/json3 | Copyright 2012-2013, Kit Cambridge | http://kit.mit-license.org */
        (function (window) {
            // Convenience aliases.
            let getClass = {}.toString; let isProperty; let forEach; let
                undef;
            ...
            function has(name) {
                ...
                // supported.
                    ...
                    if (name == 'json-stringify') {
                        let stringify = JSON3.stringify; let
            ...
            // Common `[[Class]]` name aliases.
                    ...
                    isProperty = function (property) {
                        ...
                        // supports the mutable *proto* property.
                            ...
                            // unsafe transformation by the Closure Compiler.
                                let original = this.__proto__; let
                ...
                forEach = function (object, callback) {
                    let size = 0; let Properties; let members; let
                        property;
                    ...
                    // A list of non-enumerable properties inherited from `Object.prototype`.
                        ...
                        // properties.
                        forEach = function (object, callback) {
                            let isFunction = getClass.call(object) == functionClass; let property; let
                                length;
                            let hasProperty = !isFunction && typeof object.constructor !== 'function' && isHostType(object, 'hasOwnProperty') ? object.hasOwnProperty : isProperty;
                    ...
                    // Safari <= 2.0.4 enumerates shadowed properties twice.
                        ...
                        // Create a set of iterated properties.
                            let members = {}; let isFunction = getClass.call(object) == functionClass; let
                                property;
                            for (property in object) {
                ...
                // Internal: A map of control characters and their escaped equivalents.
                    ...
                    let quote = function (value) {
                        let result = '"'; let index = 0; let length = value.length; let isLarge = length > 10 && charIndexBuggy; let
                            symbols;
                        if (isLarge) {
                            symbols = value.split('');
                        }
                    ...
                    var serialize = function (property, object, callback, properties, whitespace, indentation, stack) {
                        let value; let className; let year; let month; let date; let time; let hours; let minutes; let seconds; let milliseconds; let results; let element; let index; let length; let prefix; let
                            result;
                        try {
                        ...
                        // `"null"`.
                            return value > -1 / 0 && value < 1 / 0 ? String(value) : 'null';
                    ...
                    JSON3.stringify = function (source, filter, width) {
                        let whitespace; let callback; let properties; let
                            className;
                ...
                if (!has('json-parse')) {
                    ...
                    let lex = function () {
                        let source = Source; let length = source.length; let value; let begin; let position; let isSigned; let
                            charCode;
                        while (Index < length) {
