...
cc.Class({
    ...
    prepareWebSocket: function () {
        let self = this;
        let websocketLabel = this.websocket;
        let respLabel = this.websocketResp;
        ...
        this._wsiSendBinary.onmessage = function(evt) {
            ...
            for (let i = 0; i < binary.length; i++) {
                ...
                {
                    let hexChar = '0x' + binary[i].toString('16').toUpperCase();
    ...
    sendSocketIO: function () {
        ...
        let sioclient = io.connect('ws://tools.itharbors.com:4000', { 'force new connection': true });
        ...
        sioclient.on('connect', function() {
            ...
            let msg = sioclient.tag + ' Connected!';
        ...
        sioclient.on('echotest', function (data) {
            ...
            let msg = self.tag + " says 'echotest' with data: " + data;
